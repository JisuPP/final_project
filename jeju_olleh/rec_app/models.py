...
class DjangoDf(models.Model):
    ...
    index = models.BigIntegerField(db_column='Index', primary_key=True)  # Field name made lowercase.
...
class ModelDf(models.Model):
    title = models.TextField(blank=True, null=True)
    weighted_rating = models.FloatField(db_column='weighted_Rating', blank=True, null=True)  # Field name made lowercase.
    cat3 = models.TextField(blank=True, null=True)
    mapx = models.FloatField(blank=True, null=True)
    mapy = models.FloatField(blank=True, null=True)
    overview = models.TextField(blank=True, null=True)
